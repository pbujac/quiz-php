 ...
 */
class Version20170706133304 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE results (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, quiz_id INT DEFAULT NULL, created_at DATETIME NOT NULL, score INT DEFAULT NULL, finished TINYINT(1) NOT NULL, INDEX IDX_9FA3E414A76ED395 (user_id), INDEX IDX_9FA3E414853CD175 (quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
